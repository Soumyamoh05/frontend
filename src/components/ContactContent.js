...
function ContactContent()
{
    ...
    return (
        <>
            <h1 className="sitename"><button className = "button" style = {{cursor : "pointer", padding : "5px"}} onClick = {handleHome} ><i className = "fa-solid fa-arrow-left" ></i></button> B.planet</h1>
